...
goal:
  ...
  differentiators:
    - "Not a phone replacement; it’s intentionally private + limited to known devices"
...
pin_map:
  ...
  ui_gpio_assignments:
    ...
    buttons:
      - name: "BTN_RED_cycle_recipient"
        gpio: 14
        label: "D14"
        pullup: "input_pullup"
      - name: "BTN_WHITE_record_send"
        gpio: 32
        label: "D32"
        pullup: "input_pullup"
      - name: "BTN_BLACK_play"
